...
// 添加组件 ：内容简介列表
import ZhiboList from '../../components/MsgList/ZhiboList'
...
class CommunityList extends Component {
    ...
    render() {
        ...
        */
        ...
        let zhiboListPosts = []
        if (this.props.posts[this.state.groupId] && this.props.posts[this.state.groupId].length > 0) {
            zhiboListPosts = this.props.posts[this.state.groupId]; //倒叙
        }
        // console.log(zhiboListPosts)
        //  console.log(zhiboListPosts.reverse())
        setTimeout(() => {
            console.log(zhiboListPosts.reverse())
        }, 10)
        return (
